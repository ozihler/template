...
import { CourseSectionDetailsViewComponent } from './courses/course-section-details-view/course-section-details-view.component';
...
@NgModule({
  declarations: [
    ...
    CourseSectionDetailsViewComponent
  ],
  imports: [
    BrowserModule,
    ReactiveFormsModule,
